...
App code is not in the repo yet (docs / UX mockups only). **Greenfield scaffold** — do not import FreeLingo; use `docs/architecture-for-cursor.md` §9 build order. When frontend and backend land, this checklist must be complete:
...
4. Frontend on Vercel locally: `npm run dev`, smoke Chat / Memo / Menu against mock or API.
